...
SEXP mineRonevar (SEXP x, SEXP y, SEXP alpha, SEXP C, SEXP eps, SEXP approx){
...
SEXP mineRall (SEXP x, SEXP nrx, SEXP ncx, SEXP alpha, SEXP C, SEXP eps, SEXP approx)
{
  R_len_t i, j, rx, cx;
  double score, EPS;
  double **pointers;
